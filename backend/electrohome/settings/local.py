...
LOGOUT_REDIRECT_URL = f'{FRONTEND_URL}/dashboard/login/'
...
CSRF_TRUSTED_ORIGINS = [
    ...
    # Next.js en desarrollo local (el navegador solo ve este origen;
    # Next reenvía /api/* a Django del lado del servidor).
    'http://localhost:3000',
]
